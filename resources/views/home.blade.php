        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-default">
                    <div class="box-header no-border text-center">
                        <h3 class="box-title">Carga rápida</h3>
                    ...
                    <div class="box-body">
                        <form action="#" class="text-center" style="width: 30vw;margin: 0 auto;" onsubmit="return gotoUpload()">
                            <div class="form-group">
                                <label for="">Elegir {{ucfirst(config('settings.document_label_singular'))}}</label>
            ...
            <div class="col-md-4">
                <div class="info-box bg-yellow">
                    ...
                    Total {{ucfirst(config('settings.tags_label_plural'))}} en sistema
                  </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <div class="info-box bg-green">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="progress-description">
                        que contiene {{$filesCounts}} {{ucfirst(config('settings.file_label_plural'))}}
                  </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                        ...
                        <div class="box-tools pull-right">
                            {!! Form::open(['method' => 'get','style'=>'display:inline;']) !!}
                                ...
                                <button type="button" id="activityrange" class="btn btn-default btn-sm">
                                    ...
                                    <span>Elige fechas</span> <i class="fa fa-caret-down"></i>
                                </button>
