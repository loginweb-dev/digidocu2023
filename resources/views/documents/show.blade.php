        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            <label>{{ucfirst(config('settings.document_label_singular'))}} Titulo:</label>
                            <p>{{$document->name}}</p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Creado por:</label> {{$document->createdBy->name}}
                        </div>
                        <div class="form-group">
                            <label>Creado:</label>
                        ...
                        <div class="form-group">
                            <label>Fecha:</label>
                            <span class="label label-success">{{$document->fecha}}</span>
                        </div>
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#tab_files" data-toggle="tab"
                                              aria-expanded="true">Archivos</a>
                        </li>
                        <li class=""><a href="#tab_activity" data-toggle="tab" aria-expanded="false">Flujograma</a></li>
                       
                        @can('user manage permission')
                            <li class=""><a href="#tab_permissions" data-toggle="tab"
                                            aria-expanded="false">Derivaciones</a>
                            </li>
                        @endcan
                        @can('verify', $document)
                        <li class=""><a href="#tab_verification" data-toggle="tab"
                                        aria-expanded="false">Verificacion</a></li>
                    @endcan
                    </ul>
                        ...
                        <div class="tab-pane active" id="tab_files">
                            @if (config('settings.show_missing_files_errors')=='true' && $document->status!=config('constants.STATUS.APPROVED') && count($missigDocMsgs)!=0)
                                <div class="alert alert-danger fade in alert-dismissible">
                                    ...
                                    <strong>Faltan los siguientes archivos:</strong>
                            ...
                            <div class="tab-pane" id="tab_verification">
                                @if ($document->status!=config('constants.STATUS.APPROVED'))
                                    ...
                                    <textarea class="form-control" name="vcomment" id="vcomment" rows="4"
                                              placeholder="Ingrese un comentario para verificar con un comentario (opcional)"></textarea>
                                    </div>
                                    <div class="form-group text-center">
                            ...
                            <div class="tab-pane" id="tab_permissions">
                                <div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Permisos para la Derivacion</h4>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                        ...
                                        <tr>
                                            <th colspan="3" style="font-size: 1.8rem;">
                                                ...
                                                <button type="button" class="btn btn-primary btn-xs pull-right" data-toggle="modal"
                                                    ...
                                                    <i class="fa fa-plus"></i> Nueva Derivacion
                                                </button>
                                            </th>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th colspan="3" style="font-size: 1.8rem;">Permisos heredados por etiquetas {{config('settings.tags_label_plural')}}</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th colspan="3" style="font-size: 1.8rem;">Permiso Global de {{config('settings.document_label_plural')}}</th>
                                        </tr>
                                        <tr>
                                            <th>User</th>
                                            <th>Permissions</th>
