            ...
            <div class="box-header">
                <div class="form-group hidden visible-xs">
                    <button type="button" class="btn btn-default btn-block" data-toggle="collapse"
                            data-target="#filterForm"><i class="fa fa-filter"></i> Filtros
                    </button>
                </div>
                ...
                <button type="submit" class="btn btn-default btn-sm"><i class="fa fa-filter"></i> Filtros</button>
                {!! Form::close() !!}
            </div>
            <div class="box-body">
                <div class="row">
                                        ...
                                        <div class="box-tools pull-right">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-left" role="menu">
                                                    <li><a href="{{route('documents.show',$document->id)}}">Ver</a>
                                                    </li>
                                                    @can('edit',$document)
